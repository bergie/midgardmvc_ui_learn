 ...
 * @package midgardmvc_ui_learn
 */
class midgardmvc_ui_learn_documentation
{
    ...
    public static function get_property_documentation($class)
    {
        ...
        if (empty($props))
        {
            ...
            foreach ($props as $property)
            {
                ...
                (
                    ...
                    'documentation' => midgardmvc_ui_learn_documentation::render_docblock($property->getDocComment()),
                );
        ...
        foreach ($props as $property => $value)
        {
            ...
            $type = midgardmvc_ui_learn_documentation::get_midgard_type_signature($reflectionproperty->get_midgard_type($property));
            if (   !$type
                && $property == 'metadata')
            {
            ...
            /*try
            {
                ...
                if (   strpos($type, '_') !== false
                    && class_exists($type))
                {
                    $property_doc['type_url'] = midgardmvc_core::get_instance()->dispatcher->generate_url('midgardmvc_documentation_class', array('class' => $type));
                }
            }
            catch (Exception $e)
            {
            ...
            {
                //$property_doc['link_url'] = midgardmvc_core::get_instance()->dispatcher->generate_url('midgardmvc_documentation_class', array('class' => $reflectionproperty->get_link_name($property)));
    ...
    public static function get_method_documentation($class, $method)
    {
        ...
        {
            $parametersdata[] = midgardmvc_ui_learn_documentation::get_parameter_documentation($reflectionparameter);
        }
    ...
    public static function get_class_documentation(midgard_reflection_class $reflectionclass)
    {
        ...
        $class_documentation['docblock'] = midgardmvc_ui_learn_documentation::render_docblock($reflectionclass->getDocComment());
